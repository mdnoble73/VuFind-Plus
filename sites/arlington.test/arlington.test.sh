...
if [[ ( "$1" == "start" ) || ( "$1" == "restart") ]]
	...
	../default/solr/bin/solr start -m 3g -p 8086 -a "-Dsolr.masterport=8186" -s "/data/vufind-plus/arlington.test/solr_searcher" -d "/usr/local/vufind-plus/sites/default/solr/jetty"
fi