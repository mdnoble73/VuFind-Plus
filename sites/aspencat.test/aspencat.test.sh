...
if [[ ( "$1" == "start" ) || ( "$1" == "restart") ]]
	then
		...
		../default/solr/bin/solr start -m 2g -p 8081 -a "-Dsolr.masterport=8181" -s "/data/vufind-plus/aspencat.test/solr_searcher" -d "/usr/local/vufind-plus/sites/default/solr/jetty"
fi