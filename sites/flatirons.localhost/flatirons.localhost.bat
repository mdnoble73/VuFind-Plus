...
REM Start Solr
call ..\default\solr\bin\solr.cmd start -p 8185 -m 1g -s "c:\data\vufind-plus\flatirons.localhost\solr_master" -d "c:\web\VuFind-Plus\sites\default\solr\jetty"
call ..\default\solr\bin\solr.cmd start -p 8085 -a "-Dsolr.masterport=8185" -m 2g -s "c:\data\vufind-plus\flatirons.localhost\solr_searcher" -d "c:\web\VuFind-Plus\sites\default\solr\jetty"
goto done

:stop
rem Stop Solr
call ..\default\solr5\bin\solr.cmd stop -p 8185 -d "c:\web\VuFind-Plus\sites\default\solr\jetty"
