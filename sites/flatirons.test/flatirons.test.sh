...
if [[ ( "$1" == "start" ) || ( "$1" == "restart") ]]
	then
		...
		../default/solr/bin/solr start -m 2g -p 8085 -a "-Dsolr.masterport=8185" -s "/data/vufind-plus/flatirons.test/solr_searcher" -d "/usr/local/vufind-plus/sites/default/solr/jetty"
fi