...
rem Stop Solr
  REM Stop Master
  call ..\default\solr\bin\solr.cmd stop -p 8187 -s "c:\data\vufind-plus\santafe.localhost\solr_master" -d "c:\web\VuFind-Plus\sites\default\solr\jetty"
  REM Stop Slave
  call ..\default\solr\bin\solr.cmd stop -p 8087 -s "c:\data\vufind-plus\santafe.localhost\solr_searcher" -d "c:\web\VuFind-Plus\sites\default\solr\jetty"
