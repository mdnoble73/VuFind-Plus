...
curl --remote-name --remote-time --silent --show-error --compressed --time-cond /data/vufind-plus/hoopla/marc/USA_ALL_AB.mrc http://venus.marmot.org/hooplamarc/USA_ALL_AB.mrc
...
curl --remote-name --remote-time --silent --show-error --compressed --time-cond /data/vufind-plus/hoopla/marc/USA_ALL_TV.mrc http://venus.marmot.org/hooplamarc/USA_ALL_TV.mrc
curl --remote-name --remote-time --silent --show-error --compressed --time-cond /data/vufind-plus/hoopla/marc/USA_ALL_Video.mrc http://venus.marmot.org/hooplamarc/USA_ALL_Video.mrc
