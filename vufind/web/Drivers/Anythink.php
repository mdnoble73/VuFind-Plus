		...
		if ($this->useDb){
			...
			try {
				...
				if ($foundPatron){
					...
					$subject = "PIN number for your Wake County Library Card";
					$body = "The PIN number for your Wake County Library Card is $pin.  You may use this PIN number to login to your account.";
