...
class MillenniumDriver implements DriverInterface
{
	...
	public function patronLogin($username, $password)
	{
		...
		$password = preg_replace('/[^a-zA-Z\d\s]/', '', trim($password));
...
//		$post_string = implode ('&', $post_items);
	...
	public function getSelfRegistrationFields(){
		...
		$fields[] = array('property'=>'phone', 'type'=>'text', 'label'=>'Phone (970-123-4567)', 'description'=>'Phone', 'maxLength' => 128, 'required' => false);
