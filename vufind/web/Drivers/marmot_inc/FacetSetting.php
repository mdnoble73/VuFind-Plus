...
abstract class FacetSetting extends DB_DataObject {
	...
	function getObjectStructure(){
		...
		$structure = array(
			...
			'sortMode' => array('property'=>'sortMode', 'type'=>'enum', 'label'=>'Sort', 'values' => array('1' => 'Alphabetically', '0' => 'By number of results'), 'description'=>'How the facet values should be sorted.', 'default'=>'num_results'),
