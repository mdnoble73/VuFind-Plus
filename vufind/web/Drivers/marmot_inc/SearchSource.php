...
class SearchSource extends DB_DataObject{
	...
	static function getObjectStructure(){
		...
		$structure = array(
			...
			'searchWhat' => array('property'=>'searchWhat', 'type'=>'enum', 'label'=>'Search What?', 'values' => array('catalog' => 'Catalog', 'genealogy' => 'Genealogy', 'tags' => 'Tags', 'title_browse' => 'Title Browse', 'author_browse' => 'Author Browse', 'subject_browse' => 'Subject Browse', 'overdrive' => 'OverDrive', 'worldcat' => 'World Cat', 'prospector' => 'Prospector', 'goldrush' => 'Gold Rush'), 'description'=>'What source does this search use.', 'default'=>'Catalog'),
			...
			'unscopedFilter' => array('property'=>'unscopedFilter', 'type'=>'textarea', 'label'=>'Unscoped Filter(s)', 'description'=>'Filters to use for an unscoped search.', 'hideInLists' => true),
		);
		return $structure;
	}
