...
//	public function getLinkUrl($unscoped = false) {
	...
	private static $nonProductionTeamRoles = array('attendee', 'artist', 'child', 'correspondence recipient', 'employee', 'interviewee', 'member', 'parade marshal', 'parent', 'participant', 'president', 'rodeo royalty', 'described', 'contributor', 'author', 'sibling', 'spouse' );
