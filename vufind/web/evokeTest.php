...
$curl_url = "http://www.evokecolorado.org/rest/v1/RecordService/Get_Record?recordId=" . $getLoanables->recordId[0];
curl_setopt($curl_connection, CURLOPT_URL, $curl_url);
...
$formatsForTitle = $driver->getFormatsForTitle('00005363');
print_r($formatsForTitle);

echo("<h1>Checkout title</h1>");
$checkoutResult = $driver->checkoutTitle('00005363', '0', $user);
...
$placeHoldResult = $driver->placeHold('00005362', $user);
