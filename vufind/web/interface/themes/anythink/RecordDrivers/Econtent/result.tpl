<div id="record{$summId|escape}" class="record" data-summId="{$summId|escape}" data-type="{if $source == 'OverDrive'}'OverDrive'{else}'eContent'{/if}">
...
<script type="text/javascript">
  ...
  addIdToStatusList('{$summId|escape:"javascript"}', {if $source == 'OverDrive'}'OverDrive'{else}'eContent'{/if});
