      ...
      <table class="purchaseOptionLinks">
        ...
        {foreach from=$purchaseLinks item=purchaseLink}
          <tr>
            ...
            <td>
              <a class="button" href='/EcontentRecord/{$id}/Purchase?store={$purchaseLink.storeName|escape:"url"}{if $purchaseLink.field856Index}&index={$purchaseLink.field856Index}{/if}' target='_blank'>Buy Now</a>
            </td>
          </tr>
        {/foreach}
        </tbody>
