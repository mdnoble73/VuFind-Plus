    ...
    <form action="{$url}/MyResearch/MyList/{$favList->id}" id="myListFormItem">
      <div>
        ...
        <div class="list-actions">
          ...
          {if $allowEdit}
          {*
          <button value="moveMarked" id="FavMoveMarked" onclick='return moveMarkedAction()'>Move Marked</button>
          *}
          ...
          <button value="moveMarked" id="FavMoveMarked" onclick='return moveMarkedGo()'>Move Marked</button>
          </div>
          *}
          {/if}
        </div>
