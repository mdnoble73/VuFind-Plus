<div id="econtentRecord{$listId|escape}" class="resultsList">
  <div class="imageColumn">
     ...
     {/if}
      ...
      <div class='requestThisLink' id="placeHold{$listId|escape:"url"}" style="display:none">
        <a class="button" href="{$url}/EcontentRecord/{$listId|escape:"url"}/Hold">{translate text="Place Hold"}</a>
      </div>
  </div>
  ...
  <div class="resultDetails">
    <div class="resultItemLine1">
      ...
      <h2><a href="{$url}/EcontentRecord/{$listId|escape:"url"}?searchId={$searchId}&amp;recordIndex={$recordIndex}&amp;page={$page}" class="title">{if !$listTitle|regex_replace:"/(\/|:)$/":""}{translate text='Title not available'}{else}{$listTitle|regex_replace:"/(\/|:)$/":""|truncate:180:"..."|highlight:$lookfor}{/if}</a></h2>
