<div id="sidebar-wrapper"><div id="sidebar">
  ...
  <div class="sidegroup">
    ...
    <a href="{$url}/Help/Home?topic=search" onclick="window.open('{$url}/Help/Home?topic=advsearch', 'Help', 'width=625, height=510'); return false;">{translate text="Help with Advanced Search"}</a>
        ...
        <div class="advancedSearchFacetDetails">
          ...
          <div class="advancedSearchFacetList">
            ...
            <script type="text/javascript">
              {literal}
              $(function() {
                var lexileRange = $('#lexile-range');
                var lexileFrom = $('#lexile_scorefrom');
                var lexileTo = $('#lexile_scoreto');
                lexileRange.slider({
                  range: true,
                  min: 0,
                  max: 2500,
                  ...
                  slide: function( event, ui ) {
                    lexileFrom.val(ui.values[0]);
                    lexileTo.val(ui.values[1]);
                  }
                });
                lexileFrom.change(function (){
                  lexileRange.slider('values', 0, lexileFrom.val());
                });
                lexileTo.change(function (){
                  lexileRange.slider('values', 1, lexileTo.val());
                });
              });
              {/literal}
            </script>
