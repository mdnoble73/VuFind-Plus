(function ($) {
  ...
  $(document).ready(function() {
    ...
    if (navigate_link.length > 0) {
      var iframe = $('<div id="column-outer-wrapper"><div id="column-outer"><iframe width="200" height="700" style="border: 0;" src="http://www.anythinklibraries.org/vufind/sidebar"></div></div>');
      // Add iFrame.
      iframe.css({width: 0});
