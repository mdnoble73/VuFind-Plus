...
<div class="footerCol"><p><strong>{translate text='Featured Items'}</strong></p>
	<ul>
		...
		<li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=itype_basalt%3A"Juvenile+DVD+fiction"&amp;filter[]=publishDate%3A[2013+TO+*]&amp;filter[]=local_time_since_added_basalt%3A"Month"'>{translate text='New Juvenile DVDs'}</a></li>
