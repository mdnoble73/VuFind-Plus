        ...
        <div><p><strong>{translate text='Featured Items'}</strong></p>
          <ul>
            ...
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_basalt%3A"Month"&amp;filter[]=literary-form-full%3A"Fiction"'>{translate text='New Fiction'}</a></li>
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_basalt%3A"Month"&amp;filter[]=literary-form-full%3A"Non+Fiction"'>{translate text='New Non-Fiction'}</a></li>
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_basalt%3A"Month"&amp;filter[]=format%3A"DVD"'>{translate text='New DVDs'}</a></li>
        ...
        <div><p><strong>{translate text='Find More'}</strong></p>
          <ul>
            <li><a href="http://www.basaltrld.org/Resources/index.html">{translate text='Online Resources'}</a></li>
            <li><a href="http://marmot.lib.overdrive.com" target="_blank">{translate text='Download Books & More'}</a></li>
            <li><a href="http://www.basaltrld.org/Adults/whattoread.html">{translate text="Reader's Advisory Tools"}</a></li>
        ...
        <div><p><strong>{translate text='Need Help?'}</strong></p>
          <ul>
            ...
            <li><a href="http://www.basaltrld.org/AboutUs/ContactUs.html">{translate text='Contact Us'}</a></li>
          </ul>
        </div>
        <br clear="all">
        {if !$productionServer}
