      ...
      <div id="myrating" class="stat">
        ...
        $(
         function() {literal} { {/literal}
             $('#myrating').rater({literal}{ {/literal} module:'Record', recordId: {$id}, rating:'{$ratingData.average}', recordId: '{$id}', postHref: '{$path}/Record/{$id}/AJAX?method=RateTitle'{literal} } {/literal});
         {literal} } {/literal}
	    );
        </script>
      </div>
