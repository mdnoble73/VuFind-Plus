<div class="searchform">
  ...
  {else}
    <form method="get" action="{$path}/Union/Search" id="searchForm" class="search" onsubmit='startSearch();'>
      ...
      <img src='{$path}/interface/themes/dcl/images/searchbar-search-label.png' alt='Search' />
      ...
      {/if}
      <input type="image" name="submit" value="Go" src='{$path}/interface/themes/dcl/images/searchbar-go.png' alt='{translate text="Go"}' />
      </div>
      <div id="shards">
			{if isset($shards)}
