	...
	<div id="main-content">
		...
		<div id="importMarcContainer">
			<form action="{$path}" method="post" enctype="multipart/form-data">
				...
				<p>Marc Records will be imported in a batch process.  You can check the status of your import by viewing the <a href="{$path}/EConent/MarcImportLog">import log</a>.</p>
			</form>
		</div>
	</div>
</div>