<div align="left">
  ...
  <form action="{$path}/EcontentRecord/{$id|escape:"url"}/Email" method="post" id="popupForm" name="popupForm"
        onSubmit='SendEContentEmail(&quot;{$id|escape}&quot;, this.elements[&quot;to&quot;].value,
