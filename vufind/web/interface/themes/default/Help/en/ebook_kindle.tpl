...
<ol>
<li>Select a book you want to download by clicking on the title</li>
...
<li>If the book  is transferable via USB only, you will be prompted to in Amazon to save the file to your computer (for ease, I save to the desktop). Plug your Kindle into your computer, and drag and drop the saved file into the "Documents" file in the Kindle, which appear in "My Computer"</li>
