...
Code developed by DCL is contributed back to the Open Source Community whenever possible.  
</div>

<div class='faqQuestion'>Q. What other Open Source libraries does DCL's VuFind implementation use?</div>
...
<li><a href='http://docs.jquery.com/Plugins/Autocomplete' target='_blank'>jQuery Autocomplete plugin</a></li>
