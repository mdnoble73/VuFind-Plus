	...
	<ol>
		...
		<li>If the book is currently available to check out, follow the following steps to check it out and download it:
			<ol>
				...
				<li>The title will appear in your Downloads with a .odm extension. </li>
				<li>Open OverDrive Media Console and drag the downloaded file to the OverDrive Media Console.</li>
				<li>OverDrive Media Console will then download the title to your Mac where you can listen to it.</li>
			</ol>
		</li>
		<li>Now that the Audiobook has been downloaded you can transfer it from OverDrive to an MP3 player, iPod, smart phone, burn to CD and/or listen to the audiobook directly from Overdrive on your computer</li>
	</ol>
	<p><em>
	*Note - Books return automatically on the due date. At this time there are no overdue fines, no way to return audiobooks early, and no renewals on items.
	</em></p>
</div>
{/strip}