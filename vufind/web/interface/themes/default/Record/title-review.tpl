<div style ="font-size:12px;"><span id="userreviewlink{$shortId}" class="add userreviewlink" onclick="$('.userreview').slideUp();$('#userreview{$shortId}').slideDown();">Add a Review</span></div>
