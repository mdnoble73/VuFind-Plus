<div style ="font-size:12px;" class ="alignright"><span id="userreviewlink{$id}" class="add userreviewlink" onclick="$('.userreview').slideUp();$('#userreview{$id}').slideDown();">Add a Review</span></div>
