...
<div class='review'>
	...
	{if $review.teaser}
		 <div class="reviewTeaser" id="editorialReviewTeaser{php}echo $index;{/php}">
		 ...
		 <div class="reviewTeaser" id="editorialReviewContent{php}echo $index;{/php}" style='display:none'>
		 {$review.review}
