  ...
  {/if}
    ...
    <div class="yui-ge">
      <div class="yui-u first">
        {if $record.isbn}
        <img src="{$coverUrl}/bookcover.php?isn={$record.isbn|@formatISBN}&amp;size=small" class="alignleft" alt="{translate text='Cover Image'}">
        {else}
        <img src="{$coverUrl}/bookcover.php" class="alignleft" alt="{translate text='No Cover Image'}">
        {/if}
