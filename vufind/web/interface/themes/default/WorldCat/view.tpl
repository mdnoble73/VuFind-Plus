      ...
      <b class="btop"><b></b></b>
        ...
        {* Display Book Cover *}
            ...
            <div class="alignright">
                <a href="{$coverUrl}/bookcover.php?isn={$isbn|@formatISBN}&amp;size=large">
                    <img alt="{translate text='Book Cover'}" class="recordcover" src="{$coverUrl}/bookcover.php?isn={$isbn|@formatISBN}&amp;size=medium">
                </a>
            </div>
            {else}
