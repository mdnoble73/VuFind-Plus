...
{if !empty($records)}
	...
	<div data-role="controlgroup">
		...
		*}
		<a href="#" class="request_book_bag" data-role="button" id="bag_request_button">{translate text="Place Request"}</a>
		<a href="#" class="empty_book_bag" data-role="button" id="bag_empty_button">{translate text="Empty"}</a>
	</div>
{else}
