...
{if $user}
	...
	{if $pageTemplate=="checkedout.tpl" || $pageTemplate=="eContentCheckedOut.tpl" || $pageTemplate=="overDriveCheckedOut.tpl" || $pageTemplate=="overDriveCheckedOut2.tpl"}
		<div data-role="navbar">
			<ul>
	...
	{elseif $pageTemplate=="availableHolds.tpl" || $pageTemplate=="eContentAvailableHolds.tpl" || $pageTemplate=="overDriveAvailableHolds.tpl" || $pageTemplate=="overDriveAvailableHolds2.tpl"}
		<div data-role="navbar">
			<ul>
