...
<div class="result recordId" id="recordecontentRecord{$summId|escape}">
	<h3>
	...
	{/if}
	{if $summAjaxStatus}
		<p><strong>{translate text='Status'}:</strong> <span class="ajax_availability hide statusecontentRecord{$summShortId|escape}">{translate text='Loading'}...</span></p>
