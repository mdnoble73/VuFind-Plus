  ...
  <div id="myAccountLinks">
    <div class="myAccountLink">Print Titles
	    ...
	    <div class="myAccountLink{if $pageTemplate=="holds.tpl"} active{/if}"><a href="{$path}/MyResearch/Holds">{translate text='Holds'}{if $profile.numHolds} ({$profile.numHolds}){/if}</a></div>
    </div>
