...
<div class="yui-u first resultsList">
	<div id = "holdingsSummary{$summShortId|escape:"url"}" class="holdingsSummary"  style="width:200px">
    <div class="statusSummary" id="statusSummary{$summShortId|escape:"url"}">
  ...
  <div class="yui-ge">
    ...
    <div class="resultitem">
      ...
      <div class="resultItemLine2">
        ...
        {if $summPublicationDates}{translate text='Published'} {$summPublicationDates.0|escape}{/if}
      </div>
      ...
      {/if}
      {if $summExplain}<div class='solrExplain{$summShortId}' style='display:none'>{$summExplain}</div> {/if}
    </div>
  </div>
...
<script type="text/javascript">
  $(document).ready(function(){literal} { {/literal}
      getStatusSummary('{$summId|escape:"javascript"}');
