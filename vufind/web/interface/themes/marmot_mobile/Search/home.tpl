	...
	<div data-role="content">
		...
		*}
		...
		<div data-role="controlgroup">
			...
			<a data-role="button" href='{$path}/Search/Results?lookfor=&amp;basicType=Keyword&filter[]=format_category:"eBook"&filter[]=publishDate:[2013+TO+*]"&filter[]=literary_form_full:"Fiction"&filter[]=target_audience_full:"Adult"'>New eBooks</a>
			<a data-role="button" href='{$path}/Search/Results?lookfor=&amp;basicType=Keyword&filter[]=format_category:"Audio+Books"&filter[]=publishDate:[2013+TO+*]"&filter[]=literary_form_full:"Fiction"&filter[]=target_audience_full:"Adult"'>New Audio Books</a>
		</div>
