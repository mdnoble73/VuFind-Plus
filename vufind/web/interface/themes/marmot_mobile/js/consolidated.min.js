...
var copiesData=$(data).find("Copies").text();if(copiesData){if(copiesData.length>0){$("#copiesPlaceholder").html(copiesData);$("#copiesPlaceholder").trigger("create");}else{$("#copiesPlaceholder").html("No Copies Information found, please try again later.");}}
