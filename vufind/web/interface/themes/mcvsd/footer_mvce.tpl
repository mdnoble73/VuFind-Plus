...
<div class="footerCol"><p><strong>{translate text='Find More'}</strong></p>
	<ul>
		...
		<li><a href="http://chs.mesa.k12.co.us/Library/login/index.cfm" rel="external" onclick="window.open (this.href, 'child'); return false">{translate text='Online Resources'}</a></li>
	</ul>
</div>
