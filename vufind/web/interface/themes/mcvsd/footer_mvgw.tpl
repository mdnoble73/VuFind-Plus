...
<div class="footerCol"><p><strong>{translate text='Featured Items'}</strong></p>
	<ul>
		...
		<li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_mvgw%3A"Year"&amp;filter[]=format_category%3A"Audio"'>{translate text='New Audio Books &amp; CDs'}</a></li>
		*}
	</ul>
</div>
