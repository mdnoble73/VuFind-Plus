...
<div class="footerCol"><p><strong>{translate text='Featured Items'}</strong></p>
	<ul>
		<li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_mvrr%3A"Year"&amp;filter[]=availability_toggle_mvrr%3A"Available+Now"&amp;searchSource=local&amp;filter[]=literary_form_full%3A"Fiction"'>{translate text='New Fiction'}</a></li>
		<li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_mvrr%3A"Year"&amp;filter[]=availability_toggle_mvrr%3A"Available+Now"&amp;filter[]=literary_form_full%3A"Non+Fiction"'>{translate text='New Non-Fiction'}</a></li>
		<li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_mvrr%3A"Year"&amp;filter[]=availability_toggle_mvrr%3A"Available+Now"&amp;filter[]=format%3A"DVD"'>{translate text='New DVDs'}</a></li>
	</ul>
</div>
