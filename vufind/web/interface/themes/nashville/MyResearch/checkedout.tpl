...
<div id="page-content" class="content">
	...
	<div id="main-content">
		{if $user->cat_username}
			...
			{if $offline}
				<p>The circulation system is currently offline.  Please check back later to see a list of titles you have checked out. </p>
			{else}
				{if $transList}
										...
										<td class="myAccountCell">
											...
											<div class="myAccountTitleDetails">
												<div class="resultItemLine1">
													...
													{/if}
													{if !$record.title|removeTrailingPunctuation}
														{translate text='Title not available'}
													{else}
														{$record.title|removeTrailingPunctuation|truncate:180:"..."|highlight:$lookfor}
													{/if}
													{if $record.id}
														</a>
													{/if}
