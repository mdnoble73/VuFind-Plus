...
{if $user != false}
	<div class="sidegroup">
		...
		<div id="myAccountLinks">
			...
			{if $showFines}
			<div class="myAccountLink{if $pageTemplate=="fines.tpl"} active{/if}" title="Fines and Fees"><a href="{$path}/MyResearch/Fines">{translate text='Fines and Fees'}</a></div>
			{/if}
			...
			<div class="myAccountLink{if $pageTemplate=="profile.tpl"} active{/if}"><a href="{$path}/MyResearch/Profile">{translate text='Account Settings'}</a></div>
	...
	<div class="sidegroup">
		<h4>{translate text='Lists and Recommendations'}</h4>
