		...
		{if count($overDriveCheckedOutItems) > 0}
			<div id='overdriveMediaConsoleInfo'>
				<p>
					...
					<a href="http://www.questionpoint.org/crs/servlet/org.oclc.admin.BuildForm?&institution=10447&type=1&language=1" target="_blank">Please contact us</a>, if you would like help.
				</p>
