...
<div class="footerListCol"><h2>{translate text='New Books Movies Music'}</h2>
	<ul>
				<li><a href="{$path}/Search/Results?lookfor=&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A%22Books%22&filter[]=literary_form_full%3A%22Fiction%22&filter[]=genre_facet%3A%22Fiction%22&sort=year+desc%2Ctitle+asc&view=list&searchSource=local&amp;filter[]=time_since_added%3A&quot;Week&quot;">New Fiction</a></li>
                <li><a href="{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=time_since_added%3A&quot;Week&quot;&amp;filter[]=format_category%3A&quot;Audio+Books&quot;&sort=year+desc%2Ctitle+asc&filter[]=publishDate:[{$lastYear} TO *]">New Audio Books</a></li>
                <li><a href="{$path}/Search/Results?lookfor=%2A&type=Keyword&type=Keyword&filter[]=format_category%3A%22Movies%22&filter[]=topic_facet%3A%22Feature+films%22&filter[]=publishDate:[{$lastYear} TO *]&sort=year+desc%2Ctitle+asc&searchSource=local&amp;filter[]=time_since_added%3A&quot;Week&quot;">New Movies</a></li>	                   
		<li><a href='{$path}/Search/Results?lookfor=%22Television+Series%22+OR+%22Television+Programs%22+OR+%22Television+Adaptations%22+OR+%22Television+mini+-+series%22+NOT+%22Children&#39;s%22&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A%22Movies%22&sort=year+desc%2Ctitle+asc&view=list&searchSource=local&amp;filter[]=time_since_added%3A&quot;Week&quot;'>New TV Series &amp; Shows</a></li>
...
<div class="footerListCol"><h2>Popular Fiction</h2>
	<ul>
		<li><a href='{$path}/Search/Results?lookfor=%22graphic+novels%22+OR+%22anime%22+OR+%22manga%22&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Anime, Manga &amp; Graphic Novels</a></li> 
		<li><a href='{$path}/Search/Results?lookfor=%22mystery%22+OR+%22suspense+fiction%22&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Fiction"&filter[]=genre_facet%3A"Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Mystery &amp; Suspense</a></li>    
        <li><a href='{$path}/Search/Results?lookfor=%22love+stories%22+OR+%22romance%22&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Fiction"&filter[]=genre_facet%3A"Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Romance</a></li>  
		<li><a href='{$path}/Search/Results?lookfor=%22science+fiction%22+OR+%22fantasy+fiction%22&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Fiction"&filter[]=genre_facet%3A"Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Science Fiction &amp; Fantasy</a></li> 
		<li><a href='{$path}/Search/Results?lookfor=%22horror+fiction%22&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Fiction"&filter[]=genre_facet%3A"Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Horror</a></li>
	</ul>
</div>

<div class="footerListCol"><h2>{translate text='Popular NonFiction'}</h2>
	<ul><a href='{$path}/Search/Results?lookfor=%22employment%22+OR+%22vocational+guidance%22+OR+%22job+hunting%22&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Non+Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Careers &amp; Employment</a></li>
		<li><a href='{$path}/Search/Results?lookfor=%22Microsoft+Windows%22+OR+%22Operating+systems%22+OR+%22Microsoft+Office%22+OR+%22Word+processing%22+OR+%22Mac+OS%22&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Non+Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Computers</a></li>
		<li><a href='{$path}/Search/Results?lookfor=%22Cookbooks%22+OR+%22Cooking%22+OR+%22Baking%22&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Non+Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Cookbooks</a></li>
        <li><a href='{$path}/Search/Results?lookfor=%22Garden+Ornaments+and+Furniture%22+OR+%22Gardening%22+OR+%22Vegetable+Gardening%22+OR+%22Container+Gardening%22&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Non+Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Gardening</a></li 
        ><li><a href='{$path}/Search/Results?lookfor=%22Dwellings+--+Remodeling%22+OR+%22Remodeling%22&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A"Books"&filter[]=literary_form_full%3A"Non+Fiction"&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>Home Improvement</a></li>
	</ul>
</div>

<div class="footerListCol"><h2>{translate text='For Kids'}</h2>
	<ul>
		<li><a href='{$path}/Search/Results?lookfor=&basicType=Keyword&filter[]=target_audience_full%3A"Preschool+%280-5%29"&filter[]=illustrated%3A"Illustrated"&filter[]=format_category%3A"Books"&filter[]=genre_facet%3A"Juvenile+fiction"&filter[]=publishDate:[{$lastYear} TO *]&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>New Picture Books</a></li>
		<li><a href='{$path}/Search/Results?lookfor=%22Children%27s+Films%22&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A%22Movies%22&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>New Children&#39;s Movies</a></li>	
        <li><a href='{$path}/Search/Results?lookfor=%22Children%27s+Television+Series%22+OR+%22Children%27s+Television+Programs%22&type=Subject&basicType=Subject&filter[]=publishDate:[{$lastYear} TO *]&filter[]=format_category%3A%22Movies%22&sort=year+desc%2Ctitle+asc&view=list&searchSource=local'>New Children&#39;s TV Shows</a></li>
