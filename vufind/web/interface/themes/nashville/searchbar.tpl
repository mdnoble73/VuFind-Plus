...
<div class="searchform">
	{if $searchType == 'advanced'}
		...
		<br />
		<a href="{$path}/Search/Advanced?edit={$searchId}" class="small">{translate text="Edit this Search"}</a> |
...
{* 20140315 James: bad hack to staunch frequent solr errors on mixing basic and advanced search terms : should be replaced next week *}
			{*
            <input id="lookfor" placeholder="Search Keyword / Title / Author" type="search" name="lookfor" size="30" value="{$lookfor|escape:"html"|regex_replace:"/(All Fields:|Author:|Call Number:|ISBN\/ISSN\/UPC:|Keyword:|Publisher:|Series:|Subject:|Table of Contents:|Title:|Year of Publication:)/":""}" 
