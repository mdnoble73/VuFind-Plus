        ...
        <div><p><strong>{translate text='Featured Items'}</strong></p>
          <ul>
            ...
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_plateau%3A"Month"&amp;filter[]=literary-form-full%3A"Fiction"'>{translate text='New Fiction'}</a></li>
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_plateau%3A"Month"&amp;filter[]=literary-form-full%3A"Non+Fiction"'>{translate text='New Non-Fiction'}</a></li>
