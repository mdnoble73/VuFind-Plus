						...
						<div class="col-tn-9 result-value">
							...
							{if $indexedSeries}
								...
								{foreach from=$indexedSeries item=seriesItem name=loop}
									{if !isset($seriesItem.seriesTitle) || (strpos(strtolower($seriesItem.seriesTitle), strtolower($series.seriesTitle)) === false) && (strpos(strtolower($series.seriesTitle), strtolower($seriesItem.seriesTitle)) === false)}
