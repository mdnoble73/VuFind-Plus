{strip}
	...
	<div class="search-results-navigation text-center">
		<div class="btn-group">
			...
			{*{/if}*}
{*
  getPermanentId() Method is only available in the grouped work driver; Trying the getUniqueID method required by RecordInterface.
  The alternative is to build an alternate search navigation template for archive searches
*}
