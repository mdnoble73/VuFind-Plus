{strip}
	<div class="share-tools">
		...
		<a href="http://www.pinterest.com/pin/create/button/?url={$recordDriver->getLinkUrl()|escape:'url'}&media={$recordDriver->getBookcoverUrl()|escape:'url'}&description=Pin%20on%20Pinterest">
