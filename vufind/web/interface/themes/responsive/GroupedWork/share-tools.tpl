{strip}
	...
	<div class="share-tools">
		...
		{if $showShareOnExternalSites}
			...
			<a href="http://www.pinterest.com/pin/create/button/?url={$url}/{$recordDriver->getLinkUrl()|escape:'url'}&media={$url}{$recordDriver->getBookcoverUrl('medium')|escape:'url'}&description=Pin%20on%20Pinterest">
