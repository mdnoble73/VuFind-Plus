{strip}
	...
	<div class="share-tools">
		...
		{if $showShareOnExternalSites}
			...
			<a href="http://www.pinterest.com/pin/create/button/?url={$recordDriver->getLinkUrl()|escape:'url'}&media={$url}{$bookCoverUrlMedium|escape:'url'}&description=Pin%20on%20Pinterest">
