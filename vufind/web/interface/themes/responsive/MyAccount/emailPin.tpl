...
<div id="page-content" class="content">
	...
	<div id="main-content">
		...
		<div class="page">
			...
			<form id="emailPin" method="POST" action="{$path}/MyAccount/EmailPin">
				<div class="emailPinRow">
					<div class="emailPinLabel">Card Number<span class="required">*</span></div>
					<div class="emailPinInput"><input name="barcode" type="text" size="14" maxlength="14" class="required"/><input id="emailPinSubmit" name="submit" class="button"
					                                                                                                               type="submit" value="Email My Pin"/></div>
				</div>
