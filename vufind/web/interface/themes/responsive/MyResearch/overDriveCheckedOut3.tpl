...
<div id="page-content" class="row">
	...
	{if $user}
		...
		<h3>{translate text='Your Checked Out Items In OverDrive'}</h3>
		{if $userNoticeFile}
					...
					<tr>
						...
						<td>
							...
							{if $record.overdriveRead}
								<br/>
								<br/>
								<a href="#" onclick="followOverDriveDownloadLink('{$record.overDriveId}', 'ebook-overdrive')" class="btn">Read&nbsp;Online with OverDrive&nbsp;Read</a>
							{/if}
						</td>
					</tr>
				{/foreach}
