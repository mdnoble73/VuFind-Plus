...
<div class="btn-toolbar">
	<div class="btn-group btn-group-vertical btn-block">
		...
		{if $showMoreInfo !== false}
			<a href="{$recordUrl}" class="btn btn-sm btn-block"><img src="/images/silk/information.png" alt="More Info">&nbsp;More Info</a>
		{/if}
		{*
		...
		*}
		<a href="{$path}/Record/{$summId|escape:"url"}/SimilarTitles" class="btn btn-sm btn-block"><img src="/images/silk/arrow_switch.png">&nbsp;More Like This</a>
		{if $showComments == 1}
		...
		{/if}
		{if $showFavorites == 1}
			<a href="{$path}/Resource/Save?id={$summId|escape:"url"}&amp;source=VuFind" onclick="return VuFind.Record.getSaveToListForm(this, '{$summId|escape}', 'VuFind');" class="btn btn-sm btn-block"><img src="/images/silk/star_gold.png">&nbsp;{translate text='Add to favorites'}</a>
		{/if}
		{if $showTextThis == 1}
			<a href="{$path}/Record/{$id|escape:"url"}/SMS" onclick='return VuFind.ajaxLightbox("{$path}/Record/{$id|escape}/SMS?lightbox")' class="btn btn-sm btn-block"><img src="/images/silk/phone.png">&nbsp;{translate text="Text this"}</a>
		{/if}
		{if $showEmailThis == 1}
