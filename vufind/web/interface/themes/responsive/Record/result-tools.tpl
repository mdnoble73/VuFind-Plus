...
<div class="btn-toolbar">
	<div class="btn-group btn-group-vertical btn-block">
        ...
        <a href="{$path}/Record/{$summId|escape:"url"}/SimilarTitles" class="btn btn-small btn-block"><img src="{$path}/interface/themes/responsive/images/similar.png">&nbsp;Similar</a>
		{if $showComments == 1}
