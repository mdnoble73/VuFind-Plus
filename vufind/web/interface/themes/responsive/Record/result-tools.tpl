...
<div class="btn-toolbar">
	<div class="btn-group btn-group-vertical btn-block">
		{* Place hold link *}
		{if $showHoldButton} {* TODO: below call to showPlaceHold did not include module parameter *}
				<a href="#" class="btn btn-sm btn-block btn-primary" onclick="return VuFind.Record.showPlaceHold('Record', '{$summId}')" >{translate text="Place Hold"}</a>
		{/if}
		{* Book Material link *}
