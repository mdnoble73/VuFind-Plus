{strip}
	...
	{if $recordDriver->getUniformTitle()}
		<div class="row">
			<div class="result-label col-xs-12 col-xs-4">Uniform Title: </div>
			<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $recordDriver->getAuthor()}
		<div class="row">
			<div class="result-label col-xs-12 col-xs-4">Author: </div>
			<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $recordDriver->getDetailedContributors()}
		<div class="row">
			<div class="result-label col-xs-12 col-xs-4">{translate text='Contributors'}:</div>
			<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $recordDriver->getSeries()}
		<div class="series row">
			<div class="result-label col-xs-12 col-xs-4">Series: </div>
			<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $showPublicationDetails && $recordDriver->getPublicationDetails()}
		<div class="row">
			<div class="result-label col-xs-12 col-xs-4">{translate text='Published'}:</div>
			<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $showFormats}
	<div class="row">
		<div class="result-label col-xs-12 col-xs-4">{translate text='Format'}:</div>
		<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $showEditions && $recordDriver->getEdition()}
		<div class="row">
			<div class="result-label col-xs-12 col-xs-4">{translate text='Edition'}:</div>
			<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $showISBNs && count($recordDriver->getISBNs()) > 0}
		<div class="row">
			<div class="result-label col-xs-12 col-xs-4">{translate text='ISBN'}:</div>
			<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $showPhysicalDescriptions && $physicalDescriptions}
		<div class="row">
			<div class="result-label col-xs-12 col-xs-4">{translate text='Physical Desc'}:</div>
			<div class="col-xs-12 col-sm-8 result-value">
	...
	{if $mpaaRating}
		<div class="row">
			<div class="result-label col-xs-12 col-xs-4">{translate text='Rating'}:</div>
			<div class="col-xs-12 col-sm-8 result-value">{$mpaaRating|escape}</div>
		</div>
	{/if}

	{* Detailed status information *}
	<div class="row">
		<div class="result-label col-xs-12 col-xs-4">{translate text='Status'}:</div>
		<div class="col-xs-12 col-sm-8 result-value">
