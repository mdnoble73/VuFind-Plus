							...
							<div class="result-value col-tn-8">
								...
								{if $indexedSeries}
									...
									{foreach from=$indexedSeries item=seriesItem name=loop}
										{if !isset($seriesItem.seriesTitle) || (strpos(strtolower($seriesItem.seriesTitle), strtolower($summSeries.seriesTitle)) === false) && (strpos(strtolower($summSeries.seriesTitle), strtolower($seriesItem.seriesTitle)) === false)}
