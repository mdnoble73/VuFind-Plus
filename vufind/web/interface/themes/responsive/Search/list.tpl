...
<div class="row-fluid">
	...
	<div id="sidebar" class="span3">
		<div class="sidegroup well">
			{if $recordCount}
				<div class="sortpart"><label for="sort"><strong>{translate text='Sort By'}</strong></label></div>

            <div class="sortpart"><select id="sort" name="sort" onchange="document.location.href = this.options[this.selectedIndex].value;" class="input-medium">
