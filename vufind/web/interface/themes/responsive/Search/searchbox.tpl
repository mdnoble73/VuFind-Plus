	...
	{else}
		<form method="get" action="{$path}/Union/Search" id="searchForm" class="form-search">
			...
			<div class="btn-group">
				...
				<a href="{$path}/Help/Home?topic=search" title="{translate text='Search Tips'}" onclick="window.open('{$path}/Help/Home?topic=search', 'Help', 'width=625, height=510'); return false;" id="searchTips" class="btn">
