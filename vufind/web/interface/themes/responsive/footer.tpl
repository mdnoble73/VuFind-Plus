		...
		<div class="row-fluid">
				<div class="span3 offset2 footer-column" id="footer1">
					...
					<ul class="unstyled collapse footerContents" id="footerContents1">
                        ...
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Romance%22&amp;sort=id_sort+desc"'>{translate text='Adult Romance'}</a></li>
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Mystery%22&amp;sort=id_sort+desc"'>{translate text='Adult Mystery'}</a></li>
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Inspirational%22&amp;sort=id_sort+desc"'>{translate text='Inspirational'}</a></li>
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Science+Fiction%2FFantasy%2FHorror%22&amp;sort=id_sort+desc"'>{translate text='Science Fiction, Fantasy, &amp Horror'}</a></li>
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Books+for+Young+Children%22&amp;sort=id_sort+desc"'>{translate text='Picture Books &amp Beginning Readers'}</a></li>
                        ...
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Children&#039;s+Nonfiction%22&amp;sort=id_sort+desc"'>{translate text='Children\'s Nonfiction'}</a></li>
                        ...
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Non-Fiction%22&amp;sort=id_sort+desc"'>{translate text='Adult Nonfiction'}</a></li>
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+CD+Audio+Books%22&amp;sort=id_sort+desc"'>{translate text='Adult CD Audiobooks'}</a></li>
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Large+Print%22&amp;sort=id_sort+desc"'>{translate text='Large Print'}</a></li>
                        <li class="visible-phone"><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=format_category%3AeAudio&amp;sort=id_sort+desc"'>{translate text='Downloadable Audio'}</a></li>
                        <li class="hidden-phone"><a href="{$path}/Search/New_more" title="{translate text='New Books'}" class="modalDialogTrigger">{translate text='more...'}</a></li>
					</ul>
				</div>
				...
				{*<div class="span2 footer-column" id="footer3"><h4 data-toggle="collapse" data-target="#footerContents3">{translate text='Need Help?'}</h4>
                ...
                <div class="span3 footer-column" id="footer3"><h4 data-toggle="collapse" data-target="#footerContents3">{translate text='Stay Connected'}</h4>
                    <ul class="unstyled collapse footerContents" id="footerContents3">
                         ...
                         <li><a href="http://www.youtube.com/wcplonline" target="_blank" title="WCPL YouTube Channel">
                                 <img src="{img filename="youtube-icon_sm.fw.png"}" alt="WCPL YouTube Channel" title="WCPL YouTube Channel" id="wcpl_youtube"/>
                                 {translate text='YouTube'}</a></li>
                         <li><a href='http://www.twitter.com/wcplonline' target="_blank" title="WCPL Twitter Page">
                                 <img src="{img filename="twitter-icon_sm.fw.png"}" alt="WCPL Twitter Page" title="WCPL Twitter Page" id="wcpl_twit"/>
                                 {translate text='Twitter'}</a></li>
                         <li><a href='http://askwcpl.wakegov.com/' target="_blank" title="AskWCPL Answers Database">
                                 <img src="{img filename="ask_icon_sm_white.fw.png"}" alt="AskWCPL Answers Database" title="AskWCPL Answers Database" id="wcpl_ask"/>
                                 {translate text='AskWCPL'}</a></li>
                    </ul>
                 </div>
		</div>
