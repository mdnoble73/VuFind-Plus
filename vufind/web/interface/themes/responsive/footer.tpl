...
<div class="navbar navbar-static-bottom">
	<div class="navbar-inner">
		<div class="row-fluid">
				<div class="span2 offset2 footer-column" id="footer1">
					...
					<ul class="unstyled collapse footerContents" id="footerContents1">
                        ...
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Romance%22&amp;sort=id_sort+desc"'>{translate text='Adult Romance'}</a></li>
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Mystery%22&amp;sort=id_sort+desc"'>{translate text='Adult Mystery'}</a></li>
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Inspirational%22&amp;sort=id_sort+desc"'>{translate text='Inspirational'}</a></li>
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Science+Fiction%2FFantasy%2FHorror%22&amp;sort=id_sort+desc"'>{translate text='Science Fiction, Fantasy, &amp Horror'}</a></li>
                        ...
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Children&#039;s+Nonfiction%22&amp;sort=id_sort+desc"'>{translate text='Children\'s Nonfiction'}</a></li>
                        ...
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Non-Fiction%22&amp;sort=id_sort+desc"'>{translate text='Adult Nonfiction'}</a></li>
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+CD+Audio+Books%22&amp;sort=id_sort+desc"'>{translate text='Adult CD Audiobooks'}</a></li>
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=AllFields&amp;filter[]=system_list%3A%22New+Adult+Large+Print%22&amp;sort=id_sort+desc"'>{translate text='Large Print'}</a></li>
                        <li class="hidden-desktop"><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=format_category%3AeAudio&amp;sort=id_sort+desc"'>{translate text='Downloadable Audio'}</a></li>
				...
				<div class="span2 footer-column" id="footer2"><h4 data-toggle="collapse" data-target="#footerContents2">{translate text='Further Research'}</h4>
                ...
                <div class="span2 footer-column" id="footer4"><h4 data-toggle="collapse" data-target="#footerContents4">{translate text='Stay Connected'}</h4>
