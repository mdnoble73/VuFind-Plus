		...
		<div class="container">
			<div>
				<a class="brand" href="{if $homeLink}{$homeLink}{else}{$path}/{/if}">
					<img class="brand" src="{if $tinyLogo}{$tinyLogo}{else}{img filename="supp_site_brian2.fw.png"}{/if}" alt="{$librarySystemName}" title="Return to Catalog Home" id="header_logo"/>
				</a>
