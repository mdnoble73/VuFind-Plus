	...
	<div class="col-xs-12 col-sm-6 col-md-5 col-lg-4">
		...
		<div class="visible-xs btn-group btn-group-sm">
			...
			{else} {* Not Logged In *}
				...
				<a href="{$path}/MyAccount/Home" class="btn btn-sm btn-default" data-login="true" title="{translate text="Login"}" onclick="return VuFind.Account.followLinkIfLoggedIn(this);"><span class="login-icon"></span></a>
			{/if}
		</div>
	</div>
