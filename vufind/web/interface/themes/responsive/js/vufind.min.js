...
VuFind.CopyPrevention=function(){$(document).ready(function(){VuFind.CopyPrevention.init()});return{init:function(){VuFind.CopyPrevention.protect(this);$(".copy-prevention").children("img").each(this,function(){VuFind.CopyPrevention.protect(this)})},protect:function(element){if($(element).hasClass("copyprevention-processed")){return}$(element).addClass("copyprevention-processed");$(element).contextmenu(function(){return false})}}}(VuFind.CopyPrevention||{});
