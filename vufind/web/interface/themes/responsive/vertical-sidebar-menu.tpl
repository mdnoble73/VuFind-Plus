			...
			<div id="vertical-menu-bar">
				...
				<script type="text/javascript">
					...
					|| ($module == 'Archive' && $action == 'Results')|| ($module == 'Archive' && $action == 'RelatedEntities')}
						...
						{elseif (!$isLoginPage && !in_array($action, array('EmailResetPin', 'RequestPinReset', 'EmailPin', 'SelfReg', 'OfflineCirculation'))) && ($module == "MyAccount" || $module == "Admin" || $module == "Circa" || $module == "EditorialReview" || $module == "Report")}
