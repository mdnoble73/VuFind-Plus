        ...
        <div><p><strong>{translate text='Featured Items'}</strong></p>
          <ul>
            ...
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_salida%3A"Month"&amp;filter[]=literary-form-full%3A"Fiction"'>{translate text='New Fiction'}</a></li>
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_salida3A"Month"&amp;filter[]=literary-form-full%3A"Non+Fiction"'>{translate text='New Non-Fiction'}</a></li>
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_salida%3A"Month"&amp;filter[]=format%3A"DVD"'>{translate text='New DVDs'}</a></li>
            <li><a href='{$path}/Search/Results?lookfor=&amp;type=Keyword&amp;filter[]=local_time_since_added_salida%3A"Month"&amp;filter[]=format_category%3A"Audio"'>{translate text='New Audio Books & CDs'}</a></li>
          </ul>
        </div>
        ...
        <div><p><strong>{translate text='Find More'}</strong></p>
          <ul>
            <li><a href="http://salida.colibraries.org/online-resources/index_html">{translate text='Online Resources'}</a></li>
            <li><a href="http://marmot.lib.overdrive.com" target="_blank">{translate text='Download Books & More'}</a></li>
            <li><a href="http://salida.colibraries.org/books-literature/default-books-and-literature-page.html">{translate text="Reader's Advisory Tools"}</a></li>
            <li><a href="http://salida.colibraries.org/about-us/index-html">{translate text='About Us'}</a></li>
          </ul>
        </div>
