        ...
        <div><p><strong>{translate text='Featured Items'}</strong></p>
          <ul>
            <li><a href='{$path}/Search/Results?lookfor=&type=Keyword&filter[]=local_time_since_added_steamboatlibrary%3A%22Month%22&filter[]=literary-form-full%3A%22Fiction%22&filter[]=institution%3A%22Steamboat+Springs+Community+Libraries%22&filter[]=format_category%3A%22Books%22'>{translate text='New Fiction'}</a></li>
            <li><a href='{$path}/Search/Results?lookfor=&type=Keyword&filter[]=local_time_since_added_steamboatlibrary%3A%22Month%22&filter[]=literary-form-full%3A%22Non+Fiction%22&filter[]=institution%3A%22Steamboat+Springs+Community+Libraries%22&filter[]=format_category%3A%22Books%22 '>{translate text='New Non-Fiction'}</a></li>
