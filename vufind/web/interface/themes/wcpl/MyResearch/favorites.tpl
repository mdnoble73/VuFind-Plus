...
<div id="page-content" class="content">
  ...
  <div id="main-content">
    ...
    <div id="suggestionHeader" class="titleScrollerHeader">
      <span class="suggestionListTitle resultInformationLabel">Suggestions for you</span>
    </div>
    {if !$hasRatings}
    <div id="suggestionHelp">
      Suggestions are loaded based on your ratings of items in the catalog.  You have not rated anything yet.  After you rate some titles, please check back here for some personalized suggestions. 
    </div>  
    {else}
    <div id="suggestionList" class="titleScrollerWrapper">
		<div id="titleScrollerSuggestion" class="titleScrollerBody">
			...
			<div class="scrollerBodyContainer">
				...
				<div class="scrollerLoadingContainer">
					<img id="scrollerLoadingImageSuggestion" class="scrollerLoading" src="{$path}/interface/themes/{$theme}/images/loading_large.gif" alt="Loading..." />
				</div>
			</div>
		    ...
		    <div id="list{$list->id}" class="titleScrollerWrapper">
				...
				<div id="titleScrollerList{$list->id}" class="titleScrollerBody">
					...
					<div class="scrollerBodyContainer">
						...
						<div class="scrollerLoadingContainer">
							<img id="scrollerLoadingImageList{$list->id}" class="scrollerLoading" src="{$path}/interface/themes/{$theme}/images/loading_large.gif" alt="Loading..." />
						</div>
					</div>
					<div class="clearer"></div>
