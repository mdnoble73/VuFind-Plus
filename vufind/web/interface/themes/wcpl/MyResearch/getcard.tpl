...
<div id="page-content" class="content">
  ...
  <div id="main-content">
    ...
    <div class="page">
      ...
      <div class="getacardRow">
      	<div class="getacardLabel">Street Address<span class="required">*</span></div><div class="getacardInput"><input name="streetAddress" type="text" size="80" maxlength="80" class="required"/></div>
      </div>
      <div class="getacardRow">
      	<div class="getacardLabel">Apartment Number</div><div class="getacardInput"><input name="apartment" type="text" size="80" maxlength="80"/></div>
      </div>
      <div class="getacardRow">
