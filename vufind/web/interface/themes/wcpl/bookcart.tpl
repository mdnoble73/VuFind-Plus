<div id="book_bag" style="display:none;">
  ...
  <div id="bag_open_button">
    <div class = "icon plus" id="bag_summary_holder">
      ...
      <span id = "expand_bag_link">Open cart</span>
    </div>
  </div>
  ...
  <div id="book_bag_canvas" class="round left-side-round" style="display: none; ">
  	<a href="#" id="close_book_cart" onclick="toggleBagCanvas();return false;"><img src="{$path}/interface/themes/wcpl/images/close_book_cart.png" alt="Close Book Cart"/></a>
