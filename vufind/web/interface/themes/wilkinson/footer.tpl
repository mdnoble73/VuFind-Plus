{* Your footer *}
<div class="footerCol">
	<p><strong>{translate text='Featured Items'}</strong></p>
	<ul>
...
<div class="footerCol">
	<p><strong>{translate text='Search Options'}</strong></p>
	<ul>
		{if $user}
...
<div class="footerCol">
	<p><strong>{translate text='Find More'}</strong></p>
	<ul>
...
<div class="footerCol">
	<p><strong>{translate text='Need Help?'}</strong></p>
	<ul>
