...
$user->cat_password = '7357';
$user->overdriveEmail = 'james.staub@nashville.gov';

echo("<h3>Getting patron information</h3>");
$patronData = $driver->_callPatronUrl($user, 'http://integration-patron.api.overdrive.com/v1/patrons/me');
echo "<p>patronData: ";
print_r($patronData);

echo("<h3>Getting holds</h3>");
$patronData = $driver->getOverDriveHolds($user, 'http://integration-patron.api.overdrive.com');
print_r($patronData);
...
//$cancelResult = $driver->cancelOverDriveHold('0D85564B-A4B3-43D5-875D-1DF3CA06AE65', null, $user);
//print_r($cancelResult);

echo("<h3>Cancelling Non Existent Hold</h3>");
//$cancelResult = $driver->cancelOverDriveHold('12F25D77-A306-42E2-92FA-0CDA71915A57', null, $user);
//print_r($cancelResult);
...
//$selectFormatResult = $driver->selectOverDriveDownloadFormat('76c1b7d0-17f4-4c05-8397-c66c17411584', 'ebook-epub-adobe', $user); // title not on hold above
//$selectFormatResult = $driver->selectOverDriveDownloadFormat('12F25D77-A306-42E2-92FA-0CDA71915A57', 'ebook-epub-adobe', $user); // title checked out above without locking in format
...
//$returnResult = $driver->returnOverDriveItem('85AA5F57-0687-4C40-8A24-8FB5FC218270', null, $user);
//print_r($returnResult);
