...
class GenealogyReindex extends Admin_Admin{
    function launch(){
        global $configArray;
        global $interface;
        ...
        if (isset($_REQUEST["submit"])){
            ...
            $_SESSION['genealogyReindex']['currentRecord'] = 0;
            $_SESSION['genealogyReindex']['numRecords'] = $numRecords;
    
            $interface->assign('startReindex', true);
