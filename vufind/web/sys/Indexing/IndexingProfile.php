...
class IndexingProfile extends DB_DataObject{
	...
	function getObjectStructure(){
		$structure = array(
			...
			'marcEncoding' => array('property' => 'marcEncoding', 'type' => 'enum', 'label' => 'MARC Encoding', 'values' => array('MARC8', 'UTF', 'UNIMARC', 'ISO8859_1', 'BESTGUESS'), 'default' => 'MARC8'),
			...
			'indexingClass' => array('property' => 'indexingClass', 'type' => 'text', 'label' => 'Indexing Class', 'maxLength' => 50, 'description' => 'The class to use while indexing the records', 'required' => true, 'default' => 'IlsRecordProcessor'),
			...
			'translationMaps' => array(
				...
				'structure' => TranslationMap::getObjectStructure(),
				'sortable' => false,
				'storeDb' => true,
				'allowEdit' => true,
				'canEdit' => true,
