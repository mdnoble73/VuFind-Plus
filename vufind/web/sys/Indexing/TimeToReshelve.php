...
class TimeToReshelve  extends DB_DataObject{
	...
	function getObjectStructure(){
		...
		$structure = array(
			...
			'groupedStatus' => array('property'=>'groupedStatus', 'type'=>'text', 'label'=>'Grouped Status', 'description'=>'The Status to display to the when grouping multiple copies', 'hideInLists' => false, 'default'=>false),
		);
		return $structure;
	}
}